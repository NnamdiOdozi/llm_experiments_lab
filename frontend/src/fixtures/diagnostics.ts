...
export const FIXTURE_SNAPSHOT_WITH_ATTENTION: import("../types").DiagnosticSnapshot = {
  ...
  attention_maps: {
    ...
    n_layer: 4,
    n_head: 6,
    // weights[layer][head][window][window] — using a simple 3x3 pattern
    // for all 4 layers × 6 heads to keep the fixture compact
    weights: [
      // Layer 0
      [
        [[1.0, 0.0, 0.0], [0.62, 0.38, 0.0], [0.21, 0.35, 0.44]],
        [[1.0, 0.0, 0.0], [0.55, 0.45, 0.0], [0.25, 0.30, 0.45]],
        [[1.0, 0.0, 0.0], [0.60, 0.40, 0.0], [0.20, 0.40, 0.40]],
        [[1.0, 0.0, 0.0], [0.58, 0.42, 0.0], [0.18, 0.37, 0.45]],
        [[1.0, 0.0, 0.0], [0.65, 0.35, 0.0], [0.22, 0.33, 0.45]],
        [[1.0, 0.0, 0.0], [0.59, 0.41, 0.0], [0.19, 0.36, 0.45]],
      ],
      // Layer 1
      [
        [[1.0, 0.0, 0.0], [0.50, 0.50, 0.0], [0.15, 0.35, 0.50]],
        [[1.0, 0.0, 0.0], [0.48, 0.52, 0.0], [0.18, 0.32, 0.50]],
        [[1.0, 0.0, 0.0], [0.52, 0.48, 0.0], [0.16, 0.34, 0.50]],
        [[1.0, 0.0, 0.0], [0.51, 0.49, 0.0], [0.17, 0.33, 0.50]],
        [[1.0, 0.0, 0.0], [0.53, 0.47, 0.0], [0.19, 0.31, 0.50]],
        [[1.0, 0.0, 0.0], [0.49, 0.51, 0.0], [0.16, 0.34, 0.50]],
      ],
      // Layer 2
      [
        [[1.0, 0.0, 0.0], [0.45, 0.55, 0.0], [0.10, 0.40, 0.50]],
        [[1.0, 0.0, 0.0], [0.46, 0.54, 0.0], [0.12, 0.38, 0.50]],
        [[1.0, 0.0, 0.0], [0.44, 0.56, 0.0], [0.11, 0.39, 0.50]],
        [[1.0, 0.0, 0.0], [0.47, 0.53, 0.0], [0.13, 0.37, 0.50]],
        [[1.0, 0.0, 0.0], [0.43, 0.57, 0.0], [0.10, 0.40, 0.50]],
        [[1.0, 0.0, 0.0], [0.45, 0.55, 0.0], [0.11, 0.39, 0.50]],
      ],
      // Layer 3
      [
        [[1.0, 0.0, 0.0], [0.40, 0.60, 0.0], [0.08, 0.42, 0.50]],
        [[1.0, 0.0, 0.0], [0.41, 0.59, 0.0], [0.09, 0.41, 0.50]],
        [[1.0, 0.0, 0.0], [0.39, 0.61, 0.0], [0.07, 0.43, 0.50]],
        [[1.0, 0.0, 0.0], [0.42, 0.58, 0.0], [0.10, 0.40, 0.50]],
        [[1.0, 0.0, 0.0], [0.38, 0.62, 0.0], [0.08, 0.42, 0.50]],
